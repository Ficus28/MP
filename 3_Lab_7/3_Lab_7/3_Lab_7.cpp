// Необходимо написать код, при котором, строки, которые будет вводить пользователь
// Будут сортироваться от меньшего к большему через пузырёк и помещаться в список
#include <iostream>
#include <thread>
#include <mutex>
#include <string>
